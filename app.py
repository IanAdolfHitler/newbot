...
def Reply(event):
    Ktemp = KeyWord(event)
    if event.message.text == "要不要來打" and event.source.user_id == "U430c458150b6369a1b3b001b4c993c11":
...
def handle_postback(event):
    ...
    if command[0]=="來":
       ...
       line_bot_api.push_message(event.source.user_id,TextSendMessage(text="再戳我送你去取精"))   
# 處理訊息
